...
- **Discover and chat with published scopes** (org experts) and **workflows**, and pull org context (`modus-context`).
- **Manage** scopes, workflows, and context items for admins (`modus-manage`).
...
| --- | --- | --- |
| `modus-context` | Scopes, workflows, context compose, scope integration tools | `https://mcp.getmodus.com/modus?toolsets=context` |
| `modus-manage` | Create / update / deploy / delete scopes, workflows, context | `https://mcp.getmodus.com/modus?toolsets=manage` |
